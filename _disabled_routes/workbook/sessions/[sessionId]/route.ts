...
export async function GET(request: NextRequest, context: RouteParams) {
  try {
    ...
    return NextResponse.json({
      ...
      session: {
        ...sessionData,
        audio_chunks_count: parseInt(sessionData.audio_chunks_count || '0', 10),
        transcriptions_count: parseInt(sessionData.transcriptions_count || '0', 10),
        notes_count: parseInt(sessionData.notes_count || '0', 10),
        total_cost_cents: parseInt(sessionData.total_cost_cents || '0', 10),
