  ...
  try {
    ...
    if (detailed) {
      ...
      response.system_health = {
        ...systemHealth,
        recent_failures: parseInt(systemHealth?.recent_failures || '0', 10),
        recent_completions: parseInt(systemHealth?.recent_completions || '0', 10),
        avg_processing_time_seconds: parseFloat(
          systemHealth?.avg_processing_time_seconds || '0'
        ),
        cost_last_24h_cents: parseInt(systemHealth?.cost_last_24h_cents || '0', 10),
      };
