  ...
  try {
    ...
    if (detailed) {
      ...
      responseData.statistics = {
        ...overallStats,
        total_modules: parseInt(overallStats?.total_modules || '0', 10),
        completed_modules: parseInt(overallStats?.completed_modules || '0', 10),
        average_progress: parseFloat(overallStats?.average_progress || '0'),
        total_time_spent: parseInt(overallStats?.total_time_spent || '0', 10),
        total_sessions: parseInt(overallStats?.total_sessions || '0', 10),
        total_notes: parseInt(overallStats?.total_notes || '0', 10),
      };
