...
function parseArgs(): { startDate?: string; endDate?: string; cityId?: string } {
...
// Print table divider
function printDivider(width: number = 100) {
  console.log('═'.repeat(width))
}

// Print header
function printHeader(text: string, width: number = 100) {
