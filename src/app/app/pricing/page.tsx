  ...
  const pricingTiers = [
    {
      ...
      price: '$59',
      period: '/month',
      description: 'Essential tools for productivity and growth',
      icon: Package,
      features: [
    ...
    },
    {
      ...
      price: '$120',
      period: '/month',
      description: 'Complete coaching community + all apps',
      icon: Users,
      features: [
    ...
    <div className="min-h-screen bg-zinc-900">
      ...
      <main className="max-w-5xl mx-auto px-4 py-12">
            ...
            return (
              ...
              >
                ...
                <CardContent>
                  ...
                  <Button
                    className="w-full bg-green-500 hover:bg-green-600 text-black font-semibold text-lg h-12"
        ...
        <div className="text-center mt-12">
          <p className="text-zinc-400 mb-2">Questions about pricing?</p>
          <a href="mailto:support@6fbmentorship.com" className="text-green-500 hover:text-green-400 font-medium">
            Contact support
          </a>
        </div>
        ...
        <div className="text-center mt-6">
          <Link href="/app" className="text-zinc-400 hover:text-white text-sm">
            ← Back to main page
          </Link>
        </div>
      </main>
