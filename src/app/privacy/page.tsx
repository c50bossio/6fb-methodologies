...
export const metadata: Metadata = {
  ...
  description:
    'Privacy Policy for 6FB Methodologies Workshop. Learn how we collect, use, and protect your personal information.',
};
        ...
        <div className='prose prose-invert max-w-none space-y-8'>
          <section>
            ...
            <p className='mb-4 leading-relaxed'>
              6 Figure Barber LLC ("we," "our," or "us") respects your privacy
              and is committed to protecting your personal information. This
              Privacy Policy explains how we collect, use, disclose, and
              safeguard your information when you visit our website
              6fbmethodologies.com, register for our workshops, or use our
              services.
            </p>
          ...
          <section>
            ...
            <ul className='list-disc pl-6 mb-4 space-y-2'>
              ...
              <li>
                Business information (barbershop name, years of experience)
              </li>
          ...
          <section>
            ...
            <ul className='list-disc pl-6 space-y-2'>
              ...
              <li>
                Communicating workshop details, updates, and confirmations
              </li>
          ...
          <section>
            ...
            <ul className='list-disc pl-6 mb-4 space-y-2'>
              ...
              <li>
                <strong>Email providers:</strong> For communication and
                notifications
              </li>
              <li>
                <strong>Analytics services:</strong> For website performance and
                user insights
              </li>
            </ul>
            ...
            <p className='leading-relaxed'>
              ...
              or to protect our rights, safety, or the rights and safety of
              others.
            </p>
          </section>
          ...
          <section>
            ...
            <p className='mt-4 leading-relaxed'>
              ...
              <a
                href='mailto:privacy@6fbmethodologies.com'
                className='text-tomb45-green hover:underline'
              >
                privacy@6fbmethodologies.com
              </a>
              .
            </p>
          </section>
          ...
          <section className='border-t border-border-primary pt-8'>
            <p className='text-sm text-text-muted leading-relaxed'>
              ...
              laws including GDPR, CCPA, and other relevant regulations. If you
              are a California resident, you may have additional rights under
              the California Consumer Privacy Act (CCPA). Please contact us for
              more information about your specific rights.
            </p>
          </section>
        </div>
      </div>
