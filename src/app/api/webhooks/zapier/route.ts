...
let memberDatabase = new Map<string, {
  name: string
  email: string
      ...
      case 'member_updated':
        ...
        if (memberDatabase.has(normalizedEmail)) {
          ...
          memberDatabase.set(normalizedEmail, {
            ...
            membershipType: membershipQuestions?.membership_type || existingMember.membershipType,
...
export async function GET(request: NextRequest) {
  try {
    ...
    const activeMembers = Array.from(memberDatabase.values())
    ...
    return NextResponse.json({
      ...
      statistics: {
        ...
        membershipTypes: activeMembers.reduce((acc, member) => {
