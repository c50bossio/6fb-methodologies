...
export const CITY_WORKSHOPS: CityWorkshop[] = [
  {
    ...
    month: 'January 2026',
    year: 2026,
    dates: ['January 15-16', 'January 22-23'],
  ...
  },
  {
    ...
    month: 'February 2026',
    year: 2026,
    dates: ['February 12-13', 'February 19-20'],
    location: 'Location TBA',
