...
export const WORKSHOP_SEO_DATA: WorkshopSEOData = {
  ...
  description: 'Join Dre, Nate, and Bossio for an intensive 2-day workshop designed to take your barbering business to the next level. Learn proven systems, marketing strategies, and wealth-building techniques used by the most successful barbers in the industry.',
  keywords: [
    'barbering workshop',
...
export function generateWorkshopStructuredData(data: WorkshopSEOData) {
  const baseUrl = process.env.NEXT_PUBLIC_BASE_URL || 'https://6fbmethodologies.com'
  ...
  return {
    ...
    '@graph': [
      // Main Event
      {
        ...
        audience: {
          '@type': 'Audience',
          audienceType: 'Professional Barbers, Barbershop Owners, Barber Entrepreneurs'
        },
      ...
      // Course/Educational Event
      {
        ...
        description: 'Comprehensive 2-day business training for barber professionals',
        provider: {
          '@type': 'Organization',
          '@id': `${baseUrl}#organization`
        },
...
export function generateOpenGraphMetadata(data: WorkshopSEOData): Metadata['openGraph'] {
  const baseUrl = process.env.NEXT_PUBLIC_BASE_URL || 'https://6fbmethodologies.com'
...
export function generateTwitterMetadata(data: WorkshopSEOData): Metadata['twitter'] {
  const baseUrl = process.env.NEXT_PUBLIC_BASE_URL || 'https://6fbmethodologies.com'
...
export const PAGE_METADATA = {
  ...
  register: {
    ...
    description: 'Register now for the 6FB Methodologies Workshop. Choose General Admission or VIP Experience. Limited seats available. 100% money-back guarantee.',
    keywords: 'register barber workshop, barber training registration, 6fb workshop tickets, barbering seminar signup'
  },

  success: {
    title: 'Registration Confirmed | 6FB Methodologies Workshop',
    description: 'Your registration is confirmed! You\'ll receive a confirmation email with workshop details, location, and what to bring.',
    keywords: 'workshop confirmation, registration success, barber training confirmed'
  },

  speakers: {
    title: 'Meet Your Instructors | 6FB Methodologies Workshop',
    description: 'Learn from industry experts Dre, Nate, and Bossio - successful barber entrepreneurs who have built million-dollar businesses.',
    keywords: 'barber coaches, barbering instructors, successful barber entrepreneurs, business mentors'
  }
}
...
export function generateSocialMetaTags(pageType: keyof typeof PAGE_METADATA = 'home') {
