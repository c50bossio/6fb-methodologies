...
export function useFormTracking(formName: string = 'workshop_registration') {
  ...
  const trackStepProgress = useCallback(
    (step: number, stepName: string, formData?: Partial<RegistrationData>) => {
...
export function useConversionTracking() {
  ...
  const trackMemberVerification = useCallback(
    (isMember: boolean, memberName?: string, discount?: number) => {
      console.log({
  ...
  const trackCheckoutInitiation = useCallback(
    (checkoutData: {
      value: number;
      items: Array<{
        item_id: string;
  ...
  const trackPurchaseCompletion = useCallback(
    (transactionData: {
...
export function useUserBehavior() {
  ...
  const trackSectionView = useCallback(
    (sectionName: string, timeSpent?: number) => {
      console.log({
        event: 'section_view',
        event_category: 'user_behavior',
...
export function usePerformanceTracking() {
  ...
  const trackResourceLoad = useCallback(
    (resourceType: string, loadTime: number) => {
      console.log({
        event: 'resource_load',
        event_category: 'performance',
  ...
  const trackError = useCallback(
    (errorType: string, errorMessage: string, stack?: string) => {
      console.log({
...
export function useABTesting(testName: string, variants: string[]) {
  ...
  const trackExperiment = useCallback(
    (variant: string, interaction?: string) => {
      console.log({
