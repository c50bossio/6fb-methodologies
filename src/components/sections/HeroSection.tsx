    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container-custom relative z-10">
        <div className="text-center max-w-5xl mx-auto critical-content">
          ...
          >
            Join Dre, Nate, and Bossio in your region for an intensive 2-day workshop where you'll master the systems,
            marketing strategies, and wealth-building techniques that have helped thousands of barbers
          ...
          >
            <div className="flex items-center gap-2 bg-black/20 backdrop-blur-sm rounded-full px-4 py-2">
              ...
              <span className="text-white/90 font-medium">2 Intensive Days</span>
            </div>
            <div className="flex items-center gap-2 bg-black/20 backdrop-blur-sm rounded-full px-4 py-2">
              <MapPin className="w-5 h-5 text-tomb45-green" />
              <span className="text-white/90 font-medium">3 Expert Coaches</span>
            </div>
            <div className="flex items-center gap-2 bg-black/20 backdrop-blur-sm rounded-full px-4 py-2">
      ...
      >
        ...
        <div className="absolute inset-0 w-12 h-12 -m-3 rounded-full" aria-label="Scroll to next section" />
      </motion.div>
    </section>
  )
}