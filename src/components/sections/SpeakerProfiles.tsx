  ...
  const speakers = [
    {
      ...
      expertise: ['Payroll Systems', 'Enterprise Operations', 'Multi-Location Management', 'KPI Tracking'],
    ...
    },
    {
      ...
      expertise: ['Barber Systems', 'Grassroots Marketing', 'Staff Accountability', 'Client Retention'],
    ...
    },
    {
      ...
      expertise: ['Paid Advertising', 'Investment Strategy', 'Wealth Building', 'ROI Optimization'],
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="body-lg max-w-3xl mx-auto text-text-secondary">
              Our three expert coaches bring decades of combined experience and have helped
              thousands of barbers transform their businesses and build lasting wealth.
            </p>
          </motion.div>
        </div>
          ...
          <Card className="max-w-4xl mx-auto p-8 gradient-radial">
            <CardContent className="p-0">
              ...
              <p className="body-md text-text-secondary mb-6">
                Together, Dre, Nate, and Bossio cover every aspect of building and scaling
                a successful barbering business - from individual barber systems to enterprise
                operations and wealth building.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                <div>
                  <div className="w-3 h-3 bg-blue-500 rounded-full mx-auto mb-2" />
                  <span className="text-text-muted">Enterprise & Leadership</span>
                </div>
                <div>
