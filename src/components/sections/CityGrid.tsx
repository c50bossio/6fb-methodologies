      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="body-lg max-w-3xl mx-auto text-text-secondary mb-8">
              Experience the complete 6FB Methodologies in your region. Each workshop delivers
              the same comprehensive training with local market insights and networking opportunities.
            </p>
        ...
        >
          ...
          <div className="bg-background-secondary border border-border-primary rounded-xl p-8 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-text-secondary">
              <div className="flex items-start gap-3">
                ...
                <span>Complete 6FB methodology training with Dre, Nate, and Bossio</span>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-tomb45-green rounded-full mt-2 flex-shrink-0"></div>
                <span>Local market insights and networking with regional barbers</span>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-tomb45-green rounded-full mt-2 flex-shrink-0"></div>
                <span>All materials, workbooks, and certificate of completion</span>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-tomb45-green rounded-full mt-2 flex-shrink-0"></div>
          ...
          <div className="bg-tomb45-green/10 border border-tomb45-green/20 rounded-xl p-6 max-w-2xl mx-auto">
            <h4 className="font-semibold text-text-primary mb-2">Strategic Scheduling</h4>
            <p className="text-sm text-text-secondary">
              We've planned warmer cities during winter months (Dallas, Atlanta, LA) and
              cooler cities during summer (San Francisco, Chicago, NYC) for your comfort and convenience.
            </p>
          </div>
