  ...
  const benefits = [
    {
      ...
      description:
        'Identify the KPIs that actually drive income and profit in your barbering business',
    },
    {
      icon: TrendingUp,
      title: 'Clear-Cut 90-Day Plan',
      description:
        'Leave with a tailored roadmap to take your business to the next level',
    },
    {
      icon: CheckCircle,
    ...
    },
    {
      ...
      description:
        'Practical steps and accountability systems to ensure follow-through',
    },
  ];
