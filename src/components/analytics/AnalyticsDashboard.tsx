...
export function AnalyticsDashboard() {
  ...
  const [funnelData] = useState<ConversionFunnelData[]>([
    { step: 'Landing Page View', visitors: 2847, conversions: 2847, conversionRate: 100, dropOffRate: 0 },
    { step: 'Registration Started', visitors: 2847, conversions: 1423, conversionRate: 50.0, dropOffRate: 50.0 },
    { step: 'Step 1 Completed', visitors: 1423, conversions: 1138, conversionRate: 80.0, dropOffRate: 20.0 },
    { step: 'Payment Initiated', visitors: 1138, conversions: 796, conversionRate: 69.9, dropOffRate: 30.1 },
    { step: 'Purchase Completed', visitors: 796, conversions: 91, conversionRate: 11.4, dropOffRate: 88.6 }
  ])

  const [userSegments] = useState<UserSegmentData[]>([
    { segment: 'Individual Barbers', users: 1521, conversionRate: 2.8, averageValue: 497 },
    { segment: 'Shop Owners', users: 892, conversionRate: 4.1, averageValue: 497 },
    { segment: 'Enterprise/Multiple Shops', users: 434, conversionRate: 6.2, averageValue: 497 },
    { segment: '6FB Members', users: 156, conversionRate: 15.4, averageValue: 397 }
  ])

  const [trafficSources] = useState<TrafficSourceData[]>([
    { source: 'Direct', sessions: 1423, conversionRate: 4.2, revenue: 21340 },
    { source: 'Google Ads', sessions: 567, conversionRate: 5.8, revenue: 11420 },
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-3 bg-yellow-500/10 rounded-lg">
                ...
                <div>
                  ...
                  <div className="text-sm text-text-muted">
                    88.6% of users abandon the payment step. Consider A/B testing checkout flow simplification.
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-blue-500/10 rounded-lg">
                ...
                <div>
                  ...
                  <div className="text-sm text-text-muted">
                    Email traffic shows 18.2% conversion rate. Consider increasing email marketing budget.
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-green-500/10 rounded-lg">
                ...
                <div>
                  ...
                  <div className="text-sm text-text-muted">
                    6FB members have 15.4% conversion rate. Focus on member acquisition and verification flow.
                  </div>
                </div>
              </div>
            </div>
