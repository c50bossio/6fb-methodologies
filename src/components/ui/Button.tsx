...
const buttonVariants = cva(
  'inline-flex items-center justify-center font-semibold transition-all duration-200 focus-ring disabled:opacity-50 disabled:pointer-events-none',
  {
    variants: {
      variant: {
        primary: 'bg-tomb45-green hover:bg-tomb45-green-hover text-white shadow-md hover:shadow-lg hover:shadow-green-glow/25',
        secondary: 'bg-background-secondary hover:bg-background-accent text-text-primary border border-border-primary shadow-dark hover:shadow-dark-lg',
        ghost: 'bg-transparent hover:bg-background-secondary text-text-primary',
        outline: 'bg-transparent border-2 border-tomb45-green text-tomb45-green hover:bg-tomb45-green hover:text-white',
