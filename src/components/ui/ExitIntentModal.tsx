          ...
          >
            <Card className='border-border-primary shadow-2xl'>
              <CardHeader className='text-center relative'>
                ...
                <CardTitle className='text-xl mb-2'>How Can We Help?</CardTitle>

                <p className='text-sm text-text-secondary'>
                  We understand that timing and decisions matter. Let us know
                        ...
                        <div className='flex items-center gap-3'>
                          ...
                          <div className='text-left'>
                            ...
                            <div className='text-sm text-text-secondary'>
                              Get early bird pricing (10% off through this week)
                            </div>
                          </div>
                      ...
                      >
                        <div className='flex items-center gap-3'>
                          ...
                          <div className='text-left'>
                            ...
                            <div className='text-sm text-text-secondary'>
                              Download detailed syllabus and FAQ
                            </div>
                          </div>
                          <ArrowRight className='w-4 h-4 text-text-muted group-hover:text-tomb45-green ml-auto' />
                        </div>
                      ...
                      >
                        <div className='flex items-center gap-3'>
                          ...
                          <div className='text-left'>
                            ...
                            <div className='text-sm text-text-secondary'>
                              Join waitlist for future workshops
                            </div>
                          </div>
                          <ArrowRight className='w-4 h-4 text-text-muted group-hover:text-tomb45-green ml-auto' />
                        </div>
                  ...
                  <div className='text-center space-y-4'>
                    <div className='bg-tomb45-green/10 border border-tomb45-green/20 rounded-xl p-4'>
                      ...
                      <p className='text-sm text-text-secondary mb-3'>
                        Register this week and save 10% on either ticket option.
                        This discount is available until Sunday, then returns to
                        regular pricing.
                      </p>
                      <div className='text-xs text-tomb45-green font-medium'>
                        ✓ Valid through this Sunday • No pressure, genuine
                        savings
                      </div>
                    </div>
