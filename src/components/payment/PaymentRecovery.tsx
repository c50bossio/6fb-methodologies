  ...
  const handleContactSupport = () => {
    if (onContactSupport) {
      ...
      const subject = encodeURIComponent(
        'Payment Issue - 6FB Methodologies Workshop'
      );
  ...
  const recoveryOptions: RecoveryOption[] = [
    ...
    },
    {
      ...
      action: () => {
        ...
        alert(
          'Your registration has been saved. You have 24 hours to complete payment.'
        );
      },
      variant: 'secondary',
    },
      ...
      <div className='container-custom max-w-2xl'>
        ...
        >
          ...
          <div className='text-center mb-8'>
            ...
            <h1 className='heading-lg mb-4'>Payment Needs Attention</h1>
                  ...
                  <div className='flex items-center gap-3'>
                    ...
                    <div className='flex-1'>
                      ...
                      <p className='text-sm text-text-secondary'>
                        Complete your payment now and receive free shipping on
                        all workshop materials, plus a bonus digital resource
                        pack worth $97!
                      </p>
                    </div>
                    <Badge variant='success'>$97 Value</Badge>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
            ...
            <CardContent>
              ...
              <div className='mt-4 p-4 bg-blue-50 rounded-lg'>
                <p className='text-sm text-blue-800'>
                  <strong>Quick tip:</strong> Try using a different browser or
                  clearing your cookies. Sometimes payment issues are resolved
